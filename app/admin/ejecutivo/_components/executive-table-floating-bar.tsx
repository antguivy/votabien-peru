...
import { bulkUpdateExecutives } from "../_lib/actions";
import { toast } from "sonner";
import { AdminExecutive } from "@/interfaces/executive";

interface ExecutivesTableFloatingBarProps {
  table: Table<AdminExecutive>;
}

export function ExecutivesTableFloatingBar({
  table,
}: ExecutivesTableFloatingBarProps) {
              ...
              <Select
                onValueChange={(value: string) => {
                  ...
                  startTransition(async () => {
                    const result = await bulkUpdateExecutives({
                    ...
                    if ("data" in result && result.data) {
                      ...
                      toast.success(
                        `${result.data.count} ejecutivo(s) ${status} correctamente`,
                      );
                    }
